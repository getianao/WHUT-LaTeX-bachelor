...
%==================== 数学符号公式 ============
\usepackage{xeCJK}
\newcommand{\zhongsong}{\CJKfontspec[Path=fonts/]{STZhongsong.ttf}}%华文中宋，请自行下载字体并安装
\setsansfont{Times New Roman.ttf}[Path="fonts/"]
...
{\zihao{5} \songti \bibliography{./body/bibfile}}
